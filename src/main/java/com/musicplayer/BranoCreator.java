...
public abstract class BranoCreator {
     ...
     */
    public Brano creaBrano(String titolo, String autore, String genere, int anno, String percorsoFile, Tag tag) throws ValidazioneException {
        Brano b = costruisciBrano(titolo, autore, genere, anno, percorsoFile, tag);
        b.validaDati();
        return b;
    }
     ...
     */
    protected abstract Brano costruisciBrano(String titolo, String autore, String genere, int anno, String percorsoFile, Tag tag);
}