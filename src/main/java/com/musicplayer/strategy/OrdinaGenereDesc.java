...
public class OrdinaGenereDesc implements OrdinamentoStrategy {
    ...
    public void ordina(List<IBrano> brani) {
        Comparator<IBrano> comparator = (b1, b2) -> {
            ...
            int result = compare(brano1.getGenereEnum() != null ? brano1.getGenereEnum().getEtichetta() : "", brano2.getGenereEnum() != null ? brano2.getGenereEnum().getEtichetta() : "");
            return -result;
        };
