...
public class OrdinaTagDesc implements OrdinamentoStrategy {
    ...
    public void ordina(List<IBrano> brani) {
        Comparator<IBrano> comparator = (b1, b2) -> {
            ...
            int result = compare(brano1.getTag() != null ? brano1.getTag().getEtichetta() : "", brano2.getTag() != null ? brano2.getTag().getEtichetta() : "");
            return -result;
        };
