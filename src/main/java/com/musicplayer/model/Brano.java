...
public class Brano implements IBrano {
    ...
    public Brano(String id, String titolo, String autore, String genere, int anno, String percorsoFile, int durata,
        ...
        this.genere = Genere.fromString(genere);
        this.anno = anno;
    ...
    public String getGenere() {
        return genere.getEtichetta();
    }

    public Genere getGenereEnum() {
        return genere;
    }
    ...
    public Map<String, String> getDettagli() {
        ...
        m.put("titolo", titolo);
        m.put("autore", autore);
        m.put("genere", genere.getEtichetta());
    ...
    public void setDettagli(Map<String, String> dati) throws ValidazioneException {
        ...
        String genereStr = dati.get("genere");
        if (genereStr != null)
            this.genere = Genere.fromString(genereStr);
        ...
        if (a != null) {
            try {
                ...
                throw new ValidazioneException("L'Anno inserito non è un numero valido!",
        ...
        if (d != null) {
            try {
                ...
                throw new ValidazioneException("La Durata inserita non è un numero valido!",
    ...
    public void validaDati() throws ValidazioneException {
        ...
        if (titolo == null || titolo.isBlank()) {
            throw new ValidazioneException("Il Titolo del brano è obbligatorio!",
                    ValidazioneException.TipoErrore.CAMPO_MANCANTE, "titolo");
        }
        if (autore == null || autore.isBlank()) {
            throw new ValidazioneException("L'Autore del brano è obbligatorio!",
                    ValidazioneException.TipoErrore.CAMPO_MANCANTE, "autore");
        }
        if (genere == Genere.NESSUNO) {
            throw new ValidazioneException("Il Genere del brano è obbligatorio!",
                    ValidazioneException.TipoErrore.CAMPO_MANCANTE, "genere");
        }

        // Controllo sui valori fuori range numerico (FORMATO_NON_VALIDO)
        if (anno != 0 && (anno < 1800 || anno > 2100)) {
            throw new ValidazioneException("L'Anno inserito è fuori range (1800-2100)!",
                    ValidazioneException.TipoErrore.FORMATO_NON_VALIDO, "anno");
        }
